...
import PySimpleGUIWeb as sg                                                  # Importing pysimplegui to make a Graphical User Interface.
...
sg.theme('DarkBrown3')
layout = [[sg.Text('                      Crop Recommendation System', font=("Helvetica", 30), text_color = 'white')],                                                    # Defining the layout of the Graphical User Interface. It consist of some text, Buttons, and blanks to take Input.                                                        
...
window = sg.Window('Crop Recommendation System', layout, web_ip = '127.0.0.1', web_port = 2222, web_start_browser = False) 
